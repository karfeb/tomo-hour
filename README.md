...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/karfeb/tomo-hour)
...
git clone https://github.com/ekazor/tomo-hour
cd tomo-hour
npm install
npm update
```
